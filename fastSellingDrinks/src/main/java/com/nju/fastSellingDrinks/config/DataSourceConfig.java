package com.nju.fastSellingDrinks.config;
...
public class DataSourceConfig {
    ...
    static final String PACKAGE = "com.nju.fastSellingDrinks.mapper";
    static final String MAPPER_LOCATION = "classpath:mapper/*.xml";
    static final String ALIAS = "com.nju.fastSellingDrinks.model";
